...
class Client
{
    ...
    public function postWithFileGetContents($target, $array)
    {
        ...
        $http = array(
            ...
            'header'        => 'Authorization: Basic ' . base64_encode($authString) . "\r\n" .
                // 'header'        => 'Authorization: Basic ' . 'ODkyODk3NTg6dGVzdHBhc3N3b3JkXzd2QXR2TjQ5RThBZDZlNmloTXFJT3ZPSEM2UVY1WUttSVhneGlzTW0wVjdFcQ=='. "\r\n".
    ...
    /**
     * Recuperar la respuesta del formulario de pago de los datos POST
     */
    ...
    /**
     * recuperar el último hash calculado
     */
    ...
    /**
     * comprobar la firma del objeto kr-answer
     */
    public function checkHash($key = NULL)
    {
        $supportedHashAlgorithm = array('sha256_hmac');

        /* compruebe si el algoritmo hash es compatible */
        ...
        /* si la clave no está definida, usamos el parámetro POST kr-hash-key para elegirla */
        if (is_null($key)) {
